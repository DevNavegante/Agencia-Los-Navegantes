...
<img className="img-sabermas" loading="lazy"  alt="Agencia Los Navegantes" src="https://cdn.shopify.com/s/files/1/0654/9366/3973/files/derecha_prul7x.webp?v=1659800629" ></img>
      ...
      <Container style={{justifyContent:"center", display:"flex"}} className="contenedor-body9">
        ...
        >
     <Col sm={3}><a href="https://www.academiametrics.com/"><img loading="lazy" width={242} height={360} src="https://cdn.shopify.com/s/files/1/0610/5648/3573/files/ALN-MARZO-SEM03-GRAFICASWEB-1.png?v=1710938098"  alt="Agencia Los Navegantes"className="lazyload img hoverclas img-fluid"></img></a></Col>
        <Col id="saberMas2" sm={3}><a href="https://open.spotify.com/show/3UpMgCSvyBvTQOwVTTyIXN" ><img loading="lazy" width={242} height={360} src="https://cdn.shopify.com/s/files/1/0610/5648/3573/files/Landing_Agencia_Nosotros_60_50943fd5a5_a5754f7875_1.webp?v=1719866958" alt="Agencia Los Navegantes" className="lazyload img hoverclas img-fluid"></img></a></Col>
